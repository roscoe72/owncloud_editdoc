tinymce.PluginManager.add("image", function(e) {
    function openmanager() {
        ...
        win = e.windowManager.open({
            title: tinyMCE.settings.selectImageTitle,
            data: data,
            classes: 'filemanager',
            file: '/index.php/apps/editdoc/?editor=' + e.id + '&dir=' + encodeURIComponent(tinyMCE.settings.dir),
            filetype: 'image',
            width: 900,
            height: 600,
            inline: 1
    ...
    function t() {
        ...
        var p = [{
            ...
            items: [{
                ...
                icon: 'browse',
                onclick: openmanager,
                tooltip: tinyMCE.settings.selectButtonText
            }]
        },
        u,
        {
            ...
            items: [{
                ...
                type: "checkbox",
                checked: !0,
                text: tinyMCE.settings.keepAspectRatioText
            }]
        }];
